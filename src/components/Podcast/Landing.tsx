        ...
        <header className="bg-neutral-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-[28rem] lg:items-start lg:overflow-y-auto xl:w-[30rem]">
          ...
          <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-neutral-200 lg:px-8 lg:py-12 xl:px-12">
            ...
            <a
              ...
              href="/"
            >
              <Image alt="" width="960" height="960" src="/" />
                    ...
                    <div className="lg:max-w-4xl">
                      <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                        <div className="flex flex-col items-start">
                          ...
                          <p className="mt-1 text-base leading-7 text-neutral-700">
                            When golf-obsessed terrorists kidnapped his family
                            and held them hostage in exchange for a Golden
                            Jacket, Shooter had no choice but to win the tour at
                            any cost.
                          </p>
                          <div className="mt-4 flex items-center gap-4">
                            <button
                    ...
                    <div className="lg:max-w-4xl">
                      <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                        <div className="flex flex-col items-start">
                          ...
                          <p className="mt-1 text-base leading-7 text-neutral-700">
                            The Christmas of 1989 wasn’t the first time Harry
                            and Marv crossed paths with the McCallisters. The
                            real story starts in 1973, when Peter tripped Marv
                      ...
                      <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                        <div className="flex flex-col items-start">
                          ...
                          <p className="mt-1 text-base leading-7 text-neutral-700">
                            ...
                            liberation and freedom if you get it straight from
                            the source.
                          </p>
                          <div className="mt-4 flex items-center gap-4">
                            <button
                    ...
                    <div className="lg:max-w-4xl">
                      <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                        <div className="flex flex-col items-start">
                          ...
                          <p className="mt-1 text-base leading-7 text-neutral-700">
                            You know him as an evil supervillain, but his
                            closest friends call him Jeff, and he&apos;s just
                            doing his best to find his way in a world that
                            doesn&apos;t know what to do with a talking
                            skeleton.
                          </p>
                          <div className="mt-4 flex items-center gap-4">
                            <button
